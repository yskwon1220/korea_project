					...
					<ul>
						<li class="_9wicf" data-loc_plc-doc-id="1131800410">
							<div class="_75bjI">
								...
								&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="<c:url value="/user_page/style_hyeon/gangnam.jsp"/>" class="_3Ru_R " role="button"> 상세보기
								&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
								</a>
								</div>
							</div>	
						...
						<li class="_9wicf" data-loc_plc-doc-id="1131800410">
							<div class="_75bjI">
								...
								&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="<c:url value="/user_page/style_hyeon/gangseo.jsp"/>" class="_3Ru_R " role="button"> 상세보기
								&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
								</a>
								</div>
							</div>	
