...
<div class="row text-center">						
		<form class="" name="userInfo" method="post" action="joinreg.jsp" onsubmit="retrurn checkValue()">
...
<div class="row" style="width: 30%; float:none; margin:0 auto">
	<div class="form-group  col">
		...
		<input name="birthday" maxlength="6" class="form-control" placeholder="ex)950714">
	</div>	
</div>
