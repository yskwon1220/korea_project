      ...
      $("#point_btn").on('click',function(){
         ...
         if(Number(my_point[0])<Number(point)){
            alert("포인트가 부족합니다.");
               ...
               $('#my_point').text(currencyFormatter(hold_point)+'P');         
            }
         reset_get_point();
...
<form action="successpay" method="post">
   <!--   var form= {
         ...
         <input type="hidden" name="origin_price" value="">
         <input type="hidden" name="tot_price" value="">
         <input type="hidden" name="card_select" value="">
         <input type="hidden" name="coupon_price" value="">
         <input type="hidden" name="basic_price" value="">
   ...
   <div class="right_box">
      ...
      <div class="t_price">
         기본할인금액
         <div class="price"id="use_discount" >${discount}원</div>
      </div>
      <div class="t_price">
         쿠폰할인금액
      ...
      <div class="t_price">
         포인트 사용금액
         <div class="price"id="use_point">0원</div>
      </div>
      <hr class="hr2">
      <div class="t_price">
         총 결제 예정 금액
      ...
      <div class="t_price">
         적립 예정 포인트
         <div class="price" id="get_point">0 P</div>
      </div>
   </div>
   ...
   <div class="secon_box">
      ...
      <div class="tel_in">
         연락처<input type="text" name="tel1" value="0${fn:substring(mem.tel,0,2) }"> - <input type="text"
            name="tel2" value="${fn:substring(mem.tel,2,6) }"> - <input type="text" name="tel3"value="${fn:substring(mem.tel,6,10) }">
      </div>
      <div class="mail_in">
         이메일<input type="text" name="email1" value="${mem.email } ">@<input type="text"
            name="email2" value="${mem.email } ">
      </div>
   </div>
   ...
   <table class= "type1">
         ...
         <tr>
            ...
            <td>
               ...
               <li id="li_chk1_<c:out value="${no.index}" />"><input type="radio" name="radi" id="chk1_<c:out value="${no.index}" />" value="${cc.coupon_discount }"><label for="chk1_<c:out value="${no.index}" />">${cc.coupon_no }</label>    ( ${cc.coupon_content } ) </li>
               </c:forEach>
               </ol>
            </td>
         </tr>
