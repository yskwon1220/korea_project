         ...
         <!-- Main -->
            ...
            <div class="slideList">
                <div class="slideImg">
                    ...
                    <img src="http://www.fitness-fm.com/img/s4.jpg" style="width: 100%; height: 300px; display: inline-block;">
                </div>
                <div class="slideImg">
                    
                     <img src="http://www.fitness-fm.com/img/s3.jpg"  style="width: 100%; height: 300px; display: inline-block;">
                </div>
                <div class="slideImg">
                    
                     <img src="http://www.fitness-fm.com/img/s2.jpg"  style="width: 100%; height: 300px; display: inline-block;">
                </div>
            </div>
        </section>
        <p class= "loca">강동점</p>
...
var mapContainer = document.getElementById('map'), // 지도를 표시할 div 
    mapOption = { 
        center: new kakao.maps.LatLng(37.53617, 127.13221), // 지도의 중심좌표
        level: 4 // 지도의 확대 레벨
    };
...
// 마커가 표시될 위치입니다 
var markerPosition  = new kakao.maps.LatLng(37.53600, 127.13125); 
