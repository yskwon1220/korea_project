...
<link rel="stylesheet" href="<c:url value="${path }/resource/css/calendarstyle.css"/>" />
			...
			<div class="container">
				...
				<div class="row">
					<div class="col-md-6 col-md-offset-3 text-center fh5co-heading animate-box">
						...
						<form id="successForm" action="success" method="post">
							<table class="type08">
								<thead>
								...
								<tbody>
									...
									<tr>
								 	...
								 	<tr>
										<td>아이디</td>
										<td><input type="text" value="${user_id}" readonly="readonly"
											disabled="disabled" />
									...
									<tr>
										<td>이름</td>
										<td>
										<input type="text" value="${data.user_name}" readonly="readonly"
											disabled="disabled" />
											<input type="hidden" name="user_name" value="${data.user_name}" /></td>
									</tr>
									<tr>
										<td>비밀번호</td>
										<td><input id="pw" type="password" name="user_pw" value="" />
									...
									<tr>
										...
										<td><input type="text" name="user_tel"
											value="${data.user_tel }" /></td>
									</tr>
									<tr>
										<td>내용</td>
										<td><textarea cols="30" name="content">내용을 입력해주세요</textarea></td>
									</tr>
								</tbody>
							</table>
							<br>
							<br>
							<input type="button" onclick="gogo()" class="btn btn-primary" value="예약하기">
						</form>
					</div>
				</div>
			</div>
