	...
	<div class="card-body">
		<div class="table-responsive">
			<div class="col-sm-6" style="float: none; margin: 0 auto;">
				...
				<form action="/admin_page_/reservation/insert" method="get">
						...
						<tbody>
							<tr>
								...
								<td class="align-middle"><input class="form-control"
									type="text" name="lo_name" value="${lo_name}"></td>
							</tr>
							<tr>
							...
							<tr>
								...
								<td class="align-middle"><input class="form-control"
									type="text" id="regdate" name="resdate"></td>
							</tr>
							<tr>
					...
					<!-- 		<tr>
								...
								<td>
									<div class="btn-group btn-group-toggle" data-toggle="buttons"
										id="branch">
										<label class="btn btn-info"> <input type="radio"
											name="lo_name" value="강남점" checked="checked">강남점
										</label> <label class="btn btn-info"> <input type="radio"
											name="lo_name" value="강북점">강북점
										</label> <label class="btn btn-info"> <input type="radio"
											name="lo_name" value="강서점">강서점
										</label>
									</div>
								</td>
							</tr> -->
						<!-- 	<tr>
								<td class="align-middle">대표 사진 업로드</td>
								<td class="align-middle">
									<div class="filebox preview-image">
										<input class="upload-name" value="파일선택" disabled="disabled">
										<label for="input-file">업로드</label> <input type="file"
											id="input-file" class="upload-hidden" name="pic">
									</div>
								</td>
							</tr> -->
							<tr>
