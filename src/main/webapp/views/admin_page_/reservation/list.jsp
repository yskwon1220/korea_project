...
<!-- container fluid 아래부터  -->
                        ...
                        <div class="row">
	                        <form class="d-none d-md-inline-block form-inline ml-auto mr-0 mr-md-3 my-2 my-md-0">
	                                <div class="input-group" style="margin: 10px;">
	                                    <input class="form-control" type="text" placeholder="예약자명을 입력해주세요" onkeyup="searchFunction();" id="tr_name" />
                        ...
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                    ...
                                    <table class="table table-bordered text-center"  width="100%" cellspacing="0">
                                        <thead>
                                            <tr>
                                                <th>번호</th>
                                                <th>예약 번호</th>
                                                <th>지점 이름</th><!-- reservSet[i].getLo_name() -->
                                                <th>타입</th>
                                                <th>예약자 성함</th>
                                                <th>예약자 연락처</th>
                                                <th>트레이너 이름</th>
								...
								<!-- pagination{e} -->
                             		<div class="col-md-6" >
                                            <a style="float: right;" href="/admin_page_/reservation/insertForm" class="btn btn-info btn-primary btn-sm">신규 예약등록</a>
                                    </div>
                                </div>
                            </div>
                        </div>
