	...
	<div class="container">
		<div id="content">
			...
			<article>
				...
				<form name="modify" action="modifyReg" method="post" onsubmit="return check();" enctype="multipart/form-data">
					...
					<div class="mb-3">
						<c:choose>
							...
							<c:otherwise>
								<input type="hidden" class="upload-name" name="image"
									value="${data.image}" disabled="disabled">${data.image}
                                                             <input
