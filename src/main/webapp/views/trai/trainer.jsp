							...
							<div class="col-md-3 animate-box">
								<div class="price-box"  style="width:250px; margin-right:100px;">
									<h2 class="pricing-plan">${vo.tr_name} 강사</h2>
									 <img src="<c:url value="/images/gangsa/${vo.tr_pic}"/>" alt=""
										style="border-radius: 50px;" width="200px" height="200px" /> 
									<p>${vo.content}</p>
									<a href="../res/schedule?no=${vo.lo_no}&lo_name=${lo_name}&tr_name=${vo.tr_name}&type=${type}" class="btn btn-select-plan btn-sm">Select
										Plan</a>
