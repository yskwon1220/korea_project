					...
					<div class="pricing">
						...
						<div class="col-md-3 animate-box">
							<div class="price-box">
								...
								<img src="<c:url value="/images/fit02.jpg"/>"alt="" width="100%" height="100%" />
								<p>there live the blind texts.
								</p>
								<a href="../trai/trainer?no=${data.no}&lo_name=${data.lo_name}&type=pt" class="btn btn-select-plan btn-sm">Select Plan</a>
							</div>
						</div>
 						<div class="col-md-3 animate-box">
							<div class="price-box">
								<h2 class="pricing-plan">Health</h2>
								<img src="<c:url value="/images/fit01.jpg"/>"alt="" width="100%" height="100%" />

								<p>there live the blind texts.
								</p>
								<a href="../res/schedule?no=${data.no}&lo_name=${data.lo_name}&type=health" class="btn btn-select-plan btn-sm">Select Plan</a>
							</div>
						</div> 
