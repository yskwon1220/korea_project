...
public class payment_list {
	...
	public String toString() {
		return "payment_list [p_no=" + p_no + ", origin_price=" + origin_price + ", discount_price=" + discount_price
				+ ", point_price=" + point_price + ", pay_way=" + pay_way + ", payment_date=" + payment_date
