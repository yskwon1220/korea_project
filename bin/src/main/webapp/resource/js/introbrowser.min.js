...
var browser = function() {
	...
	var e = {
		...
		canUse : function(n) {
			...
			return n in o || "Moz" + r in o || "Webkit" + r in o
					|| "O" + r in o || "ms" + r in o
		},
		init : function() {
			...
			for (n = "other", o = 0, r = [
					...
					[ "chrome", /Chrome\/([0-9\.]+)/ ],
					[ "ie", /MSIE ([0-9]+)/ ],
					[ "ie", /Trident\/.+rv:([0-9]+)/ ] ], i = 0; i < r.length; i++)
				if (t.match(r[i][1])) {
			...
			for (e.name = n, e.version = o, n = "other", o = 0, r = [
				...
				if (t.match(r[i][1])) {
					n = r[i][0], o = parseFloat(r[i][2] ? r[i][2](RegExp.$1)
							: RegExp.$1);
					break
				}
			e.os = n, e.osVersion = o,
					e.touch = "wp" == e.os ? navigator.msMaxTouchPoints > 0
							: !!("ontouchstart" in window),
					e.mobile = "wp" == e.os || "android" == e.os
							|| "ios" == e.os || "bb" == e.os
		}
	};
	return e.init(), e
